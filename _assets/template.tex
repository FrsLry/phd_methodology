...
{
% I temporarily redefine the clearpage in oder for the bib to not be printed on a new page
\renewcommand{\clearpage}{}
\printbibliography[heading=none] %this line is used to print the bib
